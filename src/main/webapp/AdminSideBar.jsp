            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
          		...
          		<li class="nav-item">
            		<a href="AddStudents.jsp" class="nav-link">
              			<i class="nav-icon far fa-circle text-danger"></i>
              			<p class="text">Add Student</p>
            		</a>
          		</li>
          		<li class="nav-item">
            		<a href="AddHod.jsp" class="nav-link">
              			<i class="nav-icon far fa-circle text-danger"></i>
              			<p class="text">Add HOD</p>
            		</a>
          		</li>
          		<li class="nav-item">
            		<a href="AddSecurity.jsp" class="nav-link">
              			<i class="nav-icon far fa-circle text-danger"></i>
              			<p class="text">Add Security</p>
            		</a>
          		</li>
          		<li class="nav-item">
