...
public class EmailForChangePhoneNumber extends HttpServlet {
	   ...
	   if(email.equals(newEmail)) {
		   ...
		   if(userBean == null) {
			   ...
			   EmailService emailService = new EmailService();
				...
				RequestDispatcher rd = request.getRequestDispatcher("ChangeMyPhoneNumber.jsp");
				rd.forward(request, response);
		   }
	   }else {
		   	response.sendRedirect("EmailForPhoneNumber.jsp");
	   }
